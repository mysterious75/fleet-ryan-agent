...
- **Scalability** — Must work for fleets of 50 to 5,000 vehicles
- **Audit trail** — Every action must be logged and explainable

### Communication Preferences
- Prefers concise, data-driven updates
- Wants action items, not just reports
- Telegram for quick alerts, email for daily summaries
- Available for approvals during business hours (8am-6pm EST)

### Technical Context
- Uses Samsara as primary fleet platform
- Evaluating Motive (KeepTruckin') for some clients
- Has existing fleet data from 20+ years of installations
- Building TaskRaptor platform for scheduling and QA
